...
public class MainActivity extends Activity implements PilotController.Listener {
    ...
    @Override protected void onCreate(Bundle b){
        ...
        findViewById(R.id.clearLog).setOnClickListener(v->{log.setLength(0);logView.setText("");appendLog("BUILD 0.4.8-alpha31 • log cleared");});
        PilotController.get().setListener(this); refreshService(); refreshUi();
        appendLog("BUILD 0.4.8-alpha31 • persistent loading GO-watch • fruit color filter • single-tap filter • hard GO lock • second-frame BUSY veto • free run-count • 24% swipe • 3000ms settle");
    }
